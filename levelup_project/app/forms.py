...
class MySetPasswordForm(SetPasswordForm):
    ...
    new_password2 = forms.CharField(label=_("New Password"),max_length=200,strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'new-password','class':'form-control'}))     
