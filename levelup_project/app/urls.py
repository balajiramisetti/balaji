...
urlpatterns = [
     ...
     path('password-reset-confirm/<uidb64>/<token>/',auth_views.PasswordResetConfirmView.as_view(template_name='app1/paasword_reset_confirm.html',form_class=MySetPasswordForm),name='password_confirm'),
